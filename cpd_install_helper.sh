...
curl -sSL https://raw.github.ibm.com/National-Northeast-1/Cp4d-Cpdcli-Install/master/requirements.sh?token=AACTOHLMNZUJMJFIEJ4HATDDFDHLK > ~/cpd_install_env/requirements.sh || sudo curl -sSL https://raw.github.ibm.com/National-Northeast-1/Cp4d-Cpdcli-Install/master/requirements.sh?token=AACTOHLMNZUJMJFIEJ4HATDDFDHLK > ~/cpd_install_env/requirements.sh
